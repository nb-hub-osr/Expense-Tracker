...
A beginner-friendly Python command-line application for managing personal expenses.
...
- Automatic date for each expense
...
5. Follow the menu displayed on the screen.
